...
const _sfc_main$i = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.unref(slot) ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(vue.unref(slot)), vue.normalizeProps(vue.mergeProps({ key: 0 }, vue.unref(attrs))), null, 16)) : vue.renderSlot(_ctx.$slots, "default", { key: 1 });
    };
  }
});
